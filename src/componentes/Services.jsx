      ...
      <div className="flex justify-center py-10 mb-10">
        <div className="text-center">
          <div className="flex justify-center">
            <h1 className="text-5xl font-extrabold text-gray-100">Servicios</h1>
          </div>
          <div className="flex justify-center">
            <p className="text-gray-400 mt-5 w-10/12 lg:w-8/12 text-xl">
              Nuestra experiencia abarca la identificación y mitigación de
              amenazas de hacking, garantizando la integridad de la información
              crítica y la protección de la privacidad en el contexto electoral.
            </p>
          </div>
        </div>
      </div>
